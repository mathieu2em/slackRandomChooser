...
app.event('app_home_opened', async ({ event, client }) => {
  ...
  if(firstTime == false)
  {
    ...
    try {
      ...
      // List channels
      var conversations = await client.conversations.list({types:"public_channel, private_channel", exclude_archived: "true"});
...
// Generate and show the view at the end of the scrum (when everybody talked).
...
// Generate the view to display a member.
